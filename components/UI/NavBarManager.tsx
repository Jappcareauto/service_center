...
const NavbarManager = () => {
    ...
    const activedLink = (str: string) => {
        if (pathname === str) {
            return "flex items-center hover:fill-white fill-primary hover:stroke-white gap-4 p-4 my-2 transition-all rounded-xl max-md:flex max-md:justify-center max-md:p-2 hover:bg-orange-400 hover:text-white li-nav-bar-fill bg-primary-light"
        }else{
    ...
    return (
        <nav style={{ width: "270px" }}
            className=" flex  flex-col max-md:hidden justify-between bg-white h-full min-h-screen gap-8 px-4 pt-16 border-r ">
            <div>
                <div className="font-bold text-[16px] text-normal">Good Morning</div>
                <div
                    className="flex items-center w-full gap-4 mt-4 mb-6 py-3 px-4 border border-neutral rounded-2xl">
                        <Image src={"/images/default-image-manager.png"} alt="Image profile" width={48} height={48} />
                    <span className="text-[14px] font-bold max-md:hidden">Garage</span>
                </div>
                <ul>
                    <Link href={"/service_center"}  >
                        <li 
                            ...
                            <span className="block text-[14px] max-md:hidden">Dashboard</span>
                        </li>
                    </Link>
                    ...
                    <Link href="/service_center/appointments">
                        <li className={activedLink("/service_center/appointments")}>
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" 
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M18 2V4M6 2V4"  strokeWidth="1.5" strokeLinecap="round"
