...
const ProductCreateModal = (props: {file: (value: File | null) => void, fileFeatured: (value: File | null) => void,  onSubmit: (value: ProductInterface) => void, onClose: (value: boolean) => void, categories: { value: string, label: string }[] }) => {
